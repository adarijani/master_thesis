...
relative errors both on the train and the test data. To put that into perspective, ImageNet\cite{SVLL2021}\index{ImageNet} 
has around $14$ millions images and a relatively new model like GoogleNet\cite{Szegedy2014}\index{GoogleNet}, 
