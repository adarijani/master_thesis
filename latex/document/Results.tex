...
It would be not overselling to say that the activation functions we used in the \srp(the elementwise soft thresholding operator)\index{the elementwise soft thresholding operator} is so 
