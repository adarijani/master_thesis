...
\afterpage{%
  ...
  \begin{figure}[p]
    \centering
	\captionsetup{justification=centering}
    \includegraphics[width=1.0\textwidth,height=65em]{./images/twf_sat_phone/000_008_021_original.png}
    \caption{TWF Using Coded Diffraction Patterns on the Sat Phone Image from Top to Buttom: After Initialization, at Iteration $=21$, and the Original Image}
...
\afterpage{%
  ...
  \begin{figure}[p]
    \centering
	\captionsetup{justification=centering}
    \includegraphics[width=1.0\textwidth,height=65em]{./images/twf_sat_phone/030_050_499_original.png}
    \caption{TWF Using Coded Diffraction Patterns on the Sat Phone Image from Top to Buttom: At Iteration $=30$, 
    at Iteration $=50$, at Iteration $=499$, and the Original Image}
