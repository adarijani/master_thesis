...
\glsxtrnewsymbol[description={elementwise absolute value of a multidimensional array $\boldsymbol{X}$}]{elementwise abs}{\ensuremath{\left| \boldsymbol{x}\right|_{e} }}
...
\glsxtrnewsymbol[description={general $2$-$D$ basis}]{general $2$-$D$ basis}{\ensuremath{\left\{\boldsymbol{X}_{i,j}\right\}_{\substack{i=1,\ldots,m\\ j=1,\ldots,n}}}}
