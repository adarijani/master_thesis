...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\glsxtrnewsymbol[description={Wirtinger Flow}]{Wirtinger Flow}{WF}
\glsxtrnewsymbol[description={Truncated Wirtinger Flow}]{Truncated Wirtinger Flow}{TWF}
\glsxtrnewsymbol[description={Incrementally Truncated Wirtinger Flow}]{Incrementally Truncated Wirtinger Flow}{ITWF}
\glsxtrnewsymbol[description={Incrementally Minibatched Truncated Wirtinger Flow}]{Incrementally Minibatched Truncated Wirtinger Flow}{IMTWF}
\glsxtrnewsymbol[description={Reshaped Wirtinger Flow}]{Reshaped Wirtinger Flow}{RWF}
\glsxtrnewsymbol[description={Incrementally Reshaped Wirtinger Flow}]{Incrementally Reshaped Wirtinger Flow}{IRWF}
\glsxtrnewsymbol[description={Incrementally Minibatched Reshaped Wirtinger Flow}]{Incrementally Minibatched Reshaped Wirtinger Flow}{IMRWF}

%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%% Symbols %%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\glsxtrnewsymbol[description={scalar product}]{scalar product}{\ensuremath{\langle \boldsymbol{\cdot} , \boldsymbol{\cdot} \rangle}}
