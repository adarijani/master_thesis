...
\begin{Thm}\label{theorem:expectation_multiplication}
...
\end{Thm}
\begin{Proof}
Consult a book on discrete probability on any other undergraduate level book on probability theory like \cite{Chung2003} or \cite{DasGupta2011}
\end{Proof}
